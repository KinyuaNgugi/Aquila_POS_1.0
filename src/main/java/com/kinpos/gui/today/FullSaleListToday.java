...
public class FullSaleListToday extends JFrame {
    ...
    public FullSaleListToday() {
        ...
        try {
            ...
            JMenu salesMenu = new JMenu("Overall Sales"); // create purchases menu
            salesMenu.setMnemonic('O'); // set mnemonic to P
            JMenuItem directSales = new JMenuItem("Direct Sales");
            salesMenu.add(directSales);
            JMenuItem about =new JMenuItem("About...");
            salesMenu.add(about);

            String DEFAULT_QUERY = "SELECT productCode,ProductName,receiptNumber,unitsSold,sellingPricePerUnit" +
                    " FROM sale INNER JOIN stock WHERE sale.stockId=stock.stockId AND runDate="+"'"+runDateActual
            ...
            JButton byProduct=new JButton("Analysis By Product");
            byProduct.setBackground(new Color(0x2E4255));
            byProduct.setForeground(Color.black);
            byProduct.setFont(new Font("Sans Serif", Font.BOLD, 15));

            JButton byReceipt=new JButton("Analysis By Receipt Number");
            byReceipt.setBackground(new Color(0x2E4255));
            byReceipt.setForeground(Color.black);
            byReceipt.setFont(new Font("Sans Serif", Font.BOLD, 15));
            ...
            boxNorth.add(byProduct);
            boxNorth.add(byReceipt);
            boxNorth.add(full);
